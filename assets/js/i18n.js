...
(function (global) {
  ...
  var I18N = {
    es: {
      ...
      "contact.rule3": `Si decidimos avanzar, seremos nosotros quienes nos presentemos en tus oficinas — en persona y sin aviso previo. Esa primera reunión no es con nadie de nuestro equipo.`,
      "contact.rule4": `No hay negociación posible sobre estas condiciones: si no las aceptas, no trabajarás con nosotros. Nunca.`,
      "contact.rule5": `Si aceptamos reunirnos, la reunión no es gratuita: cubre nuestro tiempo, se paga por adelantado y no es reembolsable ni se descuenta del proyecto si finalmente lo aceptamos.`,
      "contact.form_code": `Código de invitación`,
      "contact.form_submit": `Enviar`,
      "contact.form_note": `Al enviar, se abre Telegram con tu código de invitación — decides tú si lo confirmas. Ya sabremos qué hacer a partir de ahí. Este sitio no recopila ni almacena nada de este formulario.`,
      ...
      "privacy.donot5": `El único formulario que tenemos no pasa por ningún servidor nuestro: solo abre Telegram con tu mensaje ya escrito`,
    ...
    en: {
      ...
      "contact.rule3": `If we decide to move forward, we're the ones who'll show up at your offices — in person, unannounced. That first meeting isn't with anyone from our team.`,
      "contact.rule4": `These terms aren't negotiable: if you don't accept them, you won't work with us. Ever.`,
      "contact.rule5": `If we agree to meet, the meeting isn't free: it covers our time, is paid upfront, and isn't refundable or deducted from the project if we ultimately take it on.`,
      "contact.form_code": `Invitation code`,
      "contact.form_submit": `Send`,
      "contact.form_note": `Submitting this opens Telegram with your invitation code — you decide whether to confirm it. We'll know what to do from there. This site collects or stores nothing from this form.`,
      ...
      "privacy.donot5": `The only form we have doesn't go through any server of ours: it just opens Telegram with your message already written`,
    ...
    fr: {
      ...
      "contact.rule3": `Si nous décidons d'avancer, ce sera nous qui nous présenterons dans vos bureaux — en personne, sans préavis. Cette première rencontre n'est avec personne de notre équipe.`,
      "contact.rule4": `Ces conditions ne sont pas négociables : si vous ne les acceptez pas, vous ne travaillerez jamais avec nous.`,
      "contact.rule5": `Si nous acceptons de nous rencontrer, la réunion n'est pas gratuite : elle couvre notre temps, se paie à l'avance, et n'est ni remboursable ni déduite du projet si nous l'acceptons finalement.`,
      "contact.form_code": `Code d'invitation`,
      "contact.form_submit": `Envoyer`,
      "contact.form_note": `En envoyant, Telegram s'ouvre avec votre code d'invitation — c'est vous qui décidez de le confirmer. Nous saurons quoi faire ensuite. Ce site ne collecte ni ne conserve rien de ce formulaire.`,
      ...
      "privacy.donot5": `Notre seul formulaire ne passe par aucun de nos serveurs : il ouvre simplement Telegram avec votre message déjà rédigé`,
    ...
    pt: {
      ...
      "contact.rule3": `Se decidirmos avançar, seremos nós que apareceremos nos seus escritórios — pessoalmente, sem aviso prévio. Essa primeira reunião não é com ninguém da nossa equipe.`,
      "contact.rule4": `Estas condições não são negociáveis: se você não as aceitar, nunca trabalhará conosco.`,
      "contact.rule5": `Se aceitarmos nos reunir, a reunião não é gratuita: cobre o nosso tempo, é paga antecipadamente e não é reembolsável nem descontada do projeto caso venhamos a aceitá-lo.`,
      "contact.form_code": `Código de convite`,
      "contact.form_submit": `Enviar`,
      "contact.form_note": `Ao enviar, o Telegram abre com o seu código de convite — você decide se confirma. Saberemos o que fazer a partir daí. Este site não coleta nem armazena nada deste formulário.`,
      ...
      "privacy.donot5": `O único formulário que temos não passa por nenhum servidor nosso: ele apenas abre o Telegram com a sua mensagem já escrita`,
    ...
    ar: {
      ...
      "contact.rule3": `إذا قررنا المضي قدمًا، فسنكون نحن من سيحضر إلى مكاتبك — شخصيًا، ودون سابق إنذار. هذا الاجتماع الأول ليس مع أي شخص من فريقنا.`,
      "contact.rule4": `هذه الشروط غير قابلة للتفاوض: إذا لم تقبلها، فلن تعمل معنا أبدًا.`,
      "contact.rule5": `إذا وافقنا على الاجتماع، فالاجتماع ليس مجانيًا: يغطي وقتنا، ويُدفع مقدمًا، ولا يُسترد أو يُخصم من المشروع إذا قبلناه في النهاية.`,
      "contact.form_code": `رمز الدعوة`,
      "contact.form_submit": `إرسال`,
      "contact.form_note": `عند الإرسال، سيُفتح Telegram برمز دعوتك — أنت من يقرر تأكيده. سنعرف ما يجب فعله بعد ذلك. هذا الموقع لا يجمع ولا يخزّن أي شيء من هذا النموذج.`,
      ...
      "privacy.donot5": `النموذج الوحيد الذي لدينا لا يمر عبر أي خادم خاص بنا: فقط يفتح Telegram برسالتك مكتوبة بالفعل`,
    ...
    zh: {
      ...
      "contact.rule3": `如果我们决定推进，将由我们亲自前往你的办公室——当面、且不事先通知。第一次会面不会有我们团队的任何人参与。`,
      "contact.rule4": `这些条件没有协商余地：如果你不接受，就永远无法与我们合作。`,
      "contact.rule5": `如果我们同意会面，该会面并非免费：费用用于支付我们的时间，需提前支付，即使最终接受该项目，该费用也不予退还或抵扣。`,
      "contact.form_code": `邀请码`,
      "contact.form_submit": `发送`,
      "contact.form_note": `点击发送后会打开Telegram，并附上你的邀请码——是否确认由你决定。之后我们会知道该怎么做。本网站不会收集或存储此表单的任何信息。`,
      ...
      "privacy.donot5": `我们唯一的表单不经过任何我们的服务器：它只是打开Telegram并显示你已写好的信息`,
    ...
    ja: {
      ...
      "contact.rule3": `先に進めることを決めた場合、私たち自身が事前の連絡なしに直接あなたのオフィスに伺います。その最初の面談は、私たちのチームの誰とでもありません。`,
      "contact.rule4": `これらの条件に交渉の余地はありません。受け入れられない場合、私たちと仕事をすることは決してありません。`,
      "contact.rule5": `面談をお受けする場合、無料ではありません。費用は私たちの時間に対するものであり、前払い制で、最終的に案件をお受けした場合でも返金や差し引きの対象にはなりません。`,
      "contact.form_code": `招待コード`,
      "contact.form_submit": `送信`,
      "contact.form_note": `送信すると、招待コードを添えてTelegramが開きます——確認するかどうかはあなた次第です。その後どうするかは私たちが把握しています。このサイトはこのフォームから何も収集・保存しません。`,
      ...
      "privacy.donot5": `私たちが持つ唯一のフォームは、私たちのサーバーを一切経由しません。あなたのメッセージがすでに書かれた状態でTelegramを開くだけです`,
