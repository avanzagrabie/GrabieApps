...
(function (global) {
  ...
  var I18N = {
    es: {
      ...
      "contact.rule2": `No respondemos contacto personal, curiosidad ni preguntas sobre presupuestos por este medio.`,
      "contact.rule3": `No se contestará ningún mensaje que no cumpla estas condiciones.`,
      "contact.rule4": `Si aceptamos reunirnos, la reunión no es gratuita: cubre nuestro tiempo, se paga por adelantado y no es reembolsable ni se descuenta del proyecto si finalmente lo aceptamos.`,
      "contact.form_name": `Nombre`, "contact.form_code": `Código de invitación`, "contact.form_message": `Mensaje`,
      "contact.form_submit": `Abrir Telegram`,
      "contact.form_note": `Se abre Telegram con tu mensaje ya redactado — decides tú si lo envías. Este sitio no recopila ni almacena nada de este formulario.`,
    ...
    en: {
      ...
      "contact.rule2": `We don't respond to personal contact, curiosity, or budget questions through this channel.`,
      "contact.rule3": `Any message that doesn't meet these conditions won't be answered.`,
      "contact.rule4": `If we agree to meet, the meeting isn't free: it covers our time, is paid upfront, and isn't refundable or deducted from the project if we ultimately take it on.`,
      "contact.form_name": `Name`, "contact.form_code": `Invitation code`, "contact.form_message": `Message`,
      "contact.form_submit": `Open Telegram`,
      "contact.form_note": `This opens Telegram with your message already drafted — you decide whether to send it. This site collects or stores nothing from this form.`,
    ...
    fr: {
      ...
      "contact.rule2": `Nous ne répondons pas aux contacts personnels, à la curiosité ni aux questions de budget par ce canal.`,
      "contact.rule3": `Tout message ne respectant pas ces conditions restera sans réponse.`,
      "contact.rule4": `Si nous acceptons de nous rencontrer, la réunion n'est pas gratuite : elle couvre notre temps, se paie à l'avance, et n'est ni remboursable ni déduite du projet si nous l'acceptons finalement.`,
      "contact.form_name": `Nom`, "contact.form_code": `Code d'invitation`, "contact.form_message": `Message`,
      "contact.form_submit": `Ouvrir Telegram`,
      "contact.form_note": `Cela ouvre Telegram avec votre message déjà rédigé — c'est vous qui décidez de l'envoyer. Ce site ne collecte ni ne conserve rien de ce formulaire.`,
    ...
    pt: {
      ...
      "contact.rule2": `Não respondemos a contato pessoal, curiosidade nem perguntas sobre orçamento por este meio.`,
      "contact.rule3": `Nenhuma mensagem que não cumpra estas condições será respondida.`,
      "contact.rule4": `Se aceitarmos nos reunir, a reunião não é gratuita: cobre o nosso tempo, é paga antecipadamente e não é reembolsável nem descontada do projeto caso venhamos a aceitá-lo.`,
      "contact.form_name": `Nome`, "contact.form_code": `Código de convite`, "contact.form_message": `Mensagem`,
      "contact.form_submit": `Abrir Telegram`,
      "contact.form_note": `Isto abre o Telegram com a sua mensagem já redigida — você decide se a envia. Este site não coleta nem armazena nada deste formulário.`,
    ...
    ar: {
      ...
      "contact.rule2": `لا نرد على التواصل الشخصي أو الفضول أو أسئلة الميزانية عبر هذه القناة.`,
      "contact.rule3": `لن يتم الرد على أي رسالة لا تستوفي هذه الشروط.`,
      "contact.rule4": `إذا وافقنا على الاجتماع، فالاجتماع ليس مجانيًا: يغطي وقتنا، ويُدفع مقدمًا، ولا يُسترد أو يُخصم من المشروع إذا قبلناه في النهاية.`,
      "contact.form_name": `الاسم`, "contact.form_code": `رمز الدعوة`, "contact.form_message": `الرسالة`,
      "contact.form_submit": `فتح Telegram`,
      "contact.form_note": `سيتم فتح Telegram برسالتك جاهزة بالفعل — أنت من يقرر إرسالها. هذا الموقع لا يجمع ولا يخزّن أي شيء من هذا النموذج.`,
    ...
    zh: {
      ...
      "contact.rule2": `我们不会通过此渠道回复私人联系、好奇咨询或预算相关问题。`,
      "contact.rule3": `任何不符合这些条件的信息都不会被回复。`,
      "contact.rule4": `如果我们同意会面，该会面并非免费：费用用于支付我们的时间，需提前支付，即使最终接受该项目，该费用也不予退还或抵扣。`,
      "contact.form_name": `姓名`, "contact.form_code": `邀请码`, "contact.form_message": `留言`,
      "contact.form_submit": `打开Telegram`,
      "contact.form_note": `这将打开Telegram，并已为你预填好信息——是否发送由你决定。本网站不会收集或存储此表单的任何信息。`,
    ...
    ja: {
      ...
      "contact.rule2": `この窓口では、個人的な連絡、興味本位のご質問、予算に関するご質問にはお答えしません。`,
      "contact.rule3": `これらの条件を満たさないメッセージには返信いたしません。`,
      "contact.rule4": `面談をお受けする場合、無料ではありません。費用は私たちの時間に対するものであり、前払い制で、最終的に案件をお受けした場合でも返金や差し引きの対象にはなりません。`,
      "contact.form_name": `お名前`, "contact.form_code": `招待コード`, "contact.form_message": `メッセージ`,
      "contact.form_submit": `Telegramを開く`,
      "contact.form_note": `Telegramがメッセージ入力済みの状態で開きます——送信するかどうかはあなた次第です。このサイトはこのフォームから何も収集・保存しません。`,
